...
def partial_tag_overlap(text: str, tag: str) -> int:
    """Length of text's suffix that could be the start of tag.

    vLLM versions newer than 0.19.1 provide this utility in
    ``vllm.tool_parsers.utils``. Keep a local copy so this patch remains
